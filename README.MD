...
- Examples
  ...
  - Save https://www.example.com/docs/guide/ and crawl its internal links without
    going above the root, except matching parent URLs under `/docs/shared/`

  ```sh
  single-file https://www.example.com/docs/guide/ --crawl-links=true --crawl-no-parent=true --crawl-no-parent-exception="^https://www\\.example\\.com/docs/shared/"
  ```
